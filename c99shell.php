...
<br><TABLE style="BORDER-COLLAPSE: collapse" height=1 cellSpacing=0 borderColorDark=#666666 cellPadding=0 width="100%" bgColor=#333333 borderColorLight=#c0c0c0 border=1><tr><td width="990" height="1" valign="top"><p align="center" class="style2">--[ c99shell v. <?php echo $shver; ?> <a href="<?php echo $surl; ?>act=about"><u><b>powered by</b></u></a> root@shell~# team - edited by Shadow| <a href="http://x-illusion.com/rootshell/forum"><font color="#FF0000">http://x-illusion.com/rootshell/forum</font></a> | Generation time: <?php echo round(getmicrotime()-starttime,4); ?> ]--</p></td>
</tr></table>
